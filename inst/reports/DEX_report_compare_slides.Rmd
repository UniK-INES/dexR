...
dexR::output_table_param_products(dp1)
...
```{r, eval=TRUE, results="hide", echo=FALSE, messages=FALSE, warning=FALSE}
dp1$fig$height <- 950
dexR::hl_figure_requests_numRequests_comp_byStatusBySubmT(c(dp1, dp2))
```
...
```{r, eval=TRUE, results="hide", echo=FALSE, messages=FALSE, warning=FALSE}
dp1$fig$height <- 950
dexR::hl_figure_requests_numRequests_comp_byStatusByStartT(c(dp1, dp2))
```
...
```{r, eval=TRUE, results="hide", echo=FALSE, messages=FALSE, warning=FALSE}
dp1$fig$height <- 750
dexR::hl_figure_requests_numRequests_comp_byProductBySubmT(c(dp1, dp2))
```
...
```{r, eval=TRUE, results="hide", echo=FALSE, messages=FALSE, warning=FALSE}
dp1$fig$height <- 750
dexR::hl_figure_requests_numRequests_comp_byProductByStartT(dp1)
```
