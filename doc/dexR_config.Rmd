...
If one if these is not correct, set the corresponding parameter by yourself (on R command line before running the sample project). To run the sample project, call:
